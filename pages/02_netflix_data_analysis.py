...
for value in movies_only["duration"]:
    duration_minutes.append(int(value.replace(" min", "")))

movies_only = movies_only.copy()
movies_only["duration_minutes"] = duration_minutes
